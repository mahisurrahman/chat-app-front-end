...
const WorkAreaChatSection = () => {
  return (
      <div className="mt-0 md:mt-[2vh] px-2 md:px-[1vw] py-4 md:py-[1vh] flex justify-between items-center border border-indigo-600 text-zinc-100 rounded-lg text-[2vw] font-poppins md:mb-0">
        <textarea
